...
import { Sparkles, Brain, Zap, ChevronDown, ChevronUp, Loader2, ChevronRight } from 'lucide-react';
...
export function TopHighlightsAll() {
  const { Strings } = useAppLanguage();

  const { list, fetchNextPage, hasNextPage, isFetchingNextPage } = useQueryHighlight();
