...
import { useQueryEvent } from '@/app/modules/use-query-event';
...
import { Clock, Calendar, Brain, Sparkles, Cpu, ChevronUp, ChevronDown, TrendingDown } from 'lucide-react';
...
export function KeyTechEvents() {
  const { Strings } = useAppLanguage();

  const { list } = useQueryEvent();
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mt-12 flex justify-center">
          <Link href="/event">
            <Button
              size="lg"
              className="rounded-full border-0 bg-gradient-to-r from-emerald-600 to-blue-600 px-8 py-3 text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-emerald-700 hover:to-blue-700 hover:shadow-xl"
            >
              <Sparkles className="mr-2 h-5 w-5" />
              {Strings.viewAllEvents}
