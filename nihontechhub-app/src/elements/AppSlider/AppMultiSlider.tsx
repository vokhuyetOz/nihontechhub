...
export function AppMultiSlider({
  name,
  defaultValue = [0, 100],
  max = 300,
  min = 0,
  ...
  const defaultValue2 = defaultValue?.[1] ?? min;
  const renderPopup = ({ value }: any) => {
    ...
    return (
      <>
        ...
        <SliderPopup height={value?.[1]} max={max} notedTitle={notedTitle} />
      </>
    );
  };
  return (
        ...
        return (
          ...
          >
            <MultiSlider
              ...
              customMarker={AppMultiSliderMarker}
              trackStyle={{
